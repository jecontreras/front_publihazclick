...
export class ActividadService implements OnInit, DoCheck {
  private url: string;
  public rta: any;
        ...
        .subscribe(
          (response: any) => {
            ...
            if (response.data.length) {
              ...
              swal('Ok', 'Estimado Usuario ya pasaron los 25 dias desde su activacion de su paquete no podras resibir las 4 Tareas de mini anuncios de su paquete asta volverlo reactivar', 'success');
            }
